...
class ProximiteTableViewController: UITableViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        PFGeoPoint.geoPointForCurrentLocationInBackground {
            ...
            if error == nil {
                ...
                query.whereKey("Coordonnees", nearGeoPoint: geoPoint!, withinKilometers: 1.0)
                query.findObjectsInBackgroundWithBlock { (objects, error) -> Void in
                    if (error == nil) {
                        ...
                        for object in objects!   {
                            ...
                            print(place)
                            let nom = object["nomArretP"]
                            print(nom)
                            var placeDistance = geoPoint!.distanceInKilometersTo(place)
                            print(placeDistance)
                        }
                    }
                }
